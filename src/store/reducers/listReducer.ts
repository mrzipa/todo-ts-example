import { ADD_LIST, ADD_TASK, DELETE_LIST, DELETE_TASK, GET_LISTS, GET_LIST_BY_ID, Lists, ListsAction, ListState, SET_LISTID_TO_DELETE, SET_LIST_TO_EDIT, SET_SELECTED_LIST, SET_TASK_TO_DELETE, SET_TASK_TO_EDIT, UNSET_TASK_TO_DELETE, UNSET_TASK_TO_EDIT, UPDATE_LIST, UPDATE_TASK } from "../types"
...
const listReducer = (state = initialState, action: ListsAction): ListState => {
  ...
  switch(action.type) {
    ...
    case UPDATE_TASK:
      ...
      clonedTask.complete = action.payload.taskState
